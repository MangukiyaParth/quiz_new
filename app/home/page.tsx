	...
	return (
		<div className="px-5 pt-[4rem] pb-20 flex flex-col items-center w-full gap-6">
			...
			<div className="w-full">
				...
				<div ref={sliderRef} id="slider" className="flex justify-between text-xs pb-0 w-full overflow-x-scroll scrollhide scroll-smooth whitespace-nowrap border-b border-gray-500 border-solid">
